    ...
    <div className="container px-4 py-8 mx-auto">
      ...
      <form onSubmit={handleSubmit} className="mt-4">
        ...
        <div className="mb-4">
          ...
          <textarea
            id="description"
            className="block w-full mt-1 bg-transparent border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            rows="3"
        ...
        <div className="mb-4">
          ...
          <input
            type="file"
            id="fileInput"
            className="block w-full mt-1 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100"
                ...
                (_, i) => (
                  <li key={i + 1}>
                    <button
                      ...
                      className={`first:ml-0 text-xs font-semibold flex w-full px-4 py-2 leading-tight bg-white border border-gray-300 rounded-md hover:bg-gray-100 ${
