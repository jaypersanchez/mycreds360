...
export { default as AdminListPage } from "./admin/sub-pages/list";
export { default as AdminCreatePage } from "./admin/sub-pages/create";
export { default as AdminEditPage } from "./admin/sub-pages/edit";
export { default as AdminViewPage } from "./admin/sub-pages/view";

export { default as StudentPage } from "./student";
export { default as InstitutionPage } from "./institution";
export { default as CertificateTemplatePage } from "./cert-template";
